    ...
    return (
      <div className="containerProject">
          <div className='container-card'>
              ...
              <div className='card'>
                <img className="imgCard" src={git} alt="img" width="350px" height="200px"/>
              ...
              <div className='card'>
                <img className="imgCard" src={rick} alt="img" width="350px" height="200px"/>
              ...
              <div className='card'>
                <img className="imgCard" src={starwars} alt="img" width="350px" height="200px"/>
